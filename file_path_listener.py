...
#     # Check for local config.json in the executable's directory first
...
#         # Center the label and button vertically and horizontally
...
#     # Load watch path from config.json
...
#             if not watch_path:
#                 print(f"Error: 'watch_path' not specified in {config_file}")
#                 exit(1)
...
#         event_handler = FolderWatcherHandler(popup_queue)
#         observer = Observer()
